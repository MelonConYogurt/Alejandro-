      ...
      <div className="flex flex-col lg:flex-row justify-center items-start w-full max-w-6xl gap-20">
        <div className="flex flex-col items-start gap-4 p-2 w-full lg:w-1/2">
          <h2 className="text-xl font-semibold text-gray-200">
            Hola, soy Alejandro velez 🫰🏻
          </h2>
          <div className="flex flex-col gap-4">
            <p className="text-sm text-gray-300">
              Soy un desarrollador Full Stack de 21 años con formación técnica
              en sistemas. Actualmente curso una carrera desarrollo de software
              en la Corporación Universitaria Remington mientras continúo mi
              formación autodidacta a través de proyectos prácticos.
            </p>
            <p className="text-sm text-gray-300">
              Me especializo en el desarrollo web con tecnologías como Next.js,
              React, Python y FastAPI. Tengo experiencia en el desarrollo de
              aplicaciones desde el frontend hasta el backend, incluyendo la
              gestión de bases de datos y la implementación de APIs.
            </p>
          </div>
          ...
          <div className="flex justify-center items-center gap-1">
            ...
            <a href="https://www.instagram.com/mono_leandro_/">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="1.5rem"
                height="1.5rem"
            ...
            <a href="https://www.youtube.com/@AlejandroVg-io3zb">
              <svg
                viewBox="0 0 256 180"
                width="1.5rem"
                height="1.5rem"
